    ...
    if(mysqli_num_rows($select_booking)>0){
        while($fetch_basket=mysqli_fetch_assoc($select_booking )){
         ...
         <div class="display-order-unit">
          <p>Name of Guest : <span><?php echo $fetch_basket['name_guest']; ?></span></p>
          <p>Name of Hotel: <span><?php echo $fetch_basket['name_hotel']; ?></span></p>
          <p>Number of guests staying: <span><?php echo $fetch_basket['num_of_guests'];?> people</span></p>
          <p>Price per night: <span><?php echo $fetch_basket['price_per_night']; ?></span> </p>
          <p>Nights booked: <span><?php echo $fetch_basket['guest_stay'];?> nights</span></p>
          <p>Your Grand total: <span><?php echo $total_price;?></span></p>
          <p><?php echo $fetch_basket['placed_on']; ?></p>
          </div>
          <br>
         <?php
        }
