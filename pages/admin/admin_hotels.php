...
<body>
    ...
    <section class="add-hotels">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <input type="number" min="0" name="price_per_night" class="box" placeholder="Enter Price per night"
                required>
            <textarea class="box" name="hotel_description" id="" cols="30" rows="10"
                placeholder="Enter the hotel's description"></textarea>
    ...
    ?>
            <div class="box">
                ...
                <div class="name">
                    <?php echo $fetch_hotels['name_hotel']; ?>
                </div>
                <div class="price">€
                    <?php echo $fetch_hotels['price_per_night']; ?>/- per night
                </div>
                <div class="description">
                    <?php echo $fetch_hotels['hotel_description']; ?>
                </div>

                <a href="admin_hotels.php?update=<?php echo $fetch_hotels['id'] ?>" class="option-btn">Update</a>
                <a href="admin_hotels.php?delete=<?php echo $fetch_hotels['id'] ?>" class="delete-btn"
...
?>
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <img src="../../static/assets/uploaded_images/<?php echo $fetch_update['image_hotel']; ?>"
                alt="image_hotel">
            <input type="text" name="update_name" value="<?php echo $fetch_update['name_hotel']; ?>" class="box"
                required placeholder="enter Hotel name">

            <textarea type="text " name="update_description" id="" cols="30" rows="4"
                placeholder="<?php echo $fetch_update['hotel_description']; ?>" class="box"></textarea>
            <input type="number" name="update_price" value="<?php echo $fetch_update['price_per_night']; ?>" min="0"
                class="box" required placeholder="enter price per night">
